This repository contains our code for a university capstone project: Profit Forest - A Profit-Driven Random Forest for Telco Churn Prediction. We finished this project with R, and there are four `.R` files: 
